...
const projects = [
...

  {
    title: "ChromaGrab",
    img: img3,
    desc: "Extract and convert colors from images or your screen instantly in your browser — 100% free, no sign-up, no upload. Get pixel-perfect codes in HEX, RGBA, HSL, CMYK, and CSS variables with automatic Tailwind CSS matching.",
    skills: ["Next.js", "TailwindCSS", "Browser APIs"],
    github: "https://github.com/rishiuttamsahu-lang/color-picker",
    demo: "https://chroma-grab.vercel.app",
    wip: false
  },
